...
coarse-grained bilayers including phospho lipids and cholesterol.
"""
...
if __name__ == "__main__":
    ...
    parser.set_defaults(pbc=False, cutoff=15.0,optimize=False,
                        max_imbalance=0.2,
                        selection="name PO4 or name ROH",   # PO-lipids and CHOL for CG)
                        )
    ...
    for groupindex in xrange(len(LF.components)):
        resnames = [a.resname for a in LF.atoms(groupindex)]
