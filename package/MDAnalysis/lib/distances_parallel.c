...
/* "MDAnalysis/lib/distances_parallel.pyx":89
...
static char __pyx_k_home_richard_code_mdanalysis_pa[] = "/home/richard/code/mdanalysis/package/MDAnalysis/lib/distances_parallel.pyx";
...
/* "MDAnalysis/lib/distances_parallel.pyx":97
...
static PyObject *__pyx_pw_3lib_8parallel_9distances_1distance_array_serial(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("distance_array_serial (wrapper)", 0);
  {
    ...
    /* "MDAnalysis/lib/distances_parallel.pyx":99
 * def distance_array_serial(np.ndarray[DTYPE_t, ndim=2] coordA, \
 *                           np.ndarray[DTYPE_t, ndim=2] coordB, \
 *                           np.ndarray[DTYPE_t, ndim=1] box = None, \             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "MDAnalysis/lib/distances_parallel.pyx":100
 *                           np.ndarray[DTYPE_t, ndim=2] coordB, \
 *                           np.ndarray[DTYPE_t, ndim=1] box = None, \
 *                           np.ndarray[DTYPE_t, ndim=2] result = None):             # <<<<<<<<<<<<<<
 *     """distance_array_serial(ref,conf[,box[,result]])
 ...
 */
  ...
  /* "MDAnalysis/lib/distances_parallel.pyx":125
 *     cdef DTYPE_t box_x, box_y, box_z
 * 
 *     if box is not None:             # <<<<<<<<<<<<<<
 *         has_box = 1
 *         box_x = box[0]
 */
  __pyx_t_1 = (((PyObject *)__pyx_v_box) != Py_None);
 ...
 */
  ...
  /* "MDAnalysis/lib/distances_parallel.pyx":133
 *     rows = coordA.shape[0];
 *     cols = coordB.shape[0];
 *     assert rows == cols, """Coordinate arrays of the same length must be used.             # <<<<<<<<<<<<<<
 *     Distance matrix must be square: number of rows (%d) must be the same as the number of columns (%d)""" % (rows, cols)
 ...
 *     if result is None:
 */
      __pyx_t_7 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_rows); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 134; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_7);
      __pyx_t_8 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_cols); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 134; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      ...
      __pyx_t_7 = 0;
      __pyx_t_8 = 0;
      __pyx_t_8 = __Pyx_PyString_Format(__pyx_kp_s_Coordinate_arrays_of_the_same_le, __pyx_t_9); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 134; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_8);
  ...
  /* "MDAnalysis/lib/distances_parallel.pyx":136
 *     Distance matrix must be square: number of rows (%d) must be the same as the number of columns (%d)""" % (rows, cols)
 * 
 *     if result is None:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "MDAnalysis/lib/distances_parallel.pyx":137
 * 
 *     if result is None:
 *         result = np.empty((rows, cols), dtype=DTYPE)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    __pyx_t_8 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 137; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_empty); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 137; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_rows); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 137; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_7 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_cols); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 137; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_7);
    ...
    __Pyx_GOTREF(__pyx_t_10);
    __pyx_t_8 = __Pyx_GetModuleGlobalName(__pyx_n_s_DTYPE); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 137; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_8);
    if (PyDict_SetItem(__pyx_t_10, __pyx_n_s_dtype, __pyx_t_8) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 137; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_9, __pyx_t_7, __pyx_t_10); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 137; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_8);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
    if (!(likely(((__pyx_t_8) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_8, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 137; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
    ...
    if (unlikely(!Py_OptimizeFlag)) {
      if (unlikely(!(((__pyx_v_result->dimensions[0]) == __pyx_v_rows) != 0))) {
        __pyx_t_8 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_rows); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 139; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_8);
        __pyx_t_10 = __Pyx_PyInt_From_Py_intptr_t((__pyx_v_result->dimensions[0])); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 139; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_10);
        ...
        __pyx_t_8 = 0;
        __pyx_t_10 = 0;
        __pyx_t_10 = __Pyx_PyString_Format(__pyx_kp_s_Results_array_should_have_d_rows, __pyx_t_7); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 139; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_10);
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
 ...
 */
    ...
    if (unlikely(!Py_OptimizeFlag)) {
      if (unlikely(!(((__pyx_v_result->dimensions[1]) == __pyx_v_cols) != 0))) {
        __pyx_t_10 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_cols); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 140; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_10);
        __pyx_t_7 = __Pyx_PyInt_From_Py_intptr_t((__pyx_v_result->dimensions[1])); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 140; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_7);
        ...
        __pyx_t_10 = 0;
        __pyx_t_7 = 0;
        __pyx_t_7 = __Pyx_PyString_Format(__pyx_kp_s_Results_array_should_have_d_colu, __pyx_t_8); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 140; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_7);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  ...
  /* "MDAnalysis/lib/distances_parallel.pyx":143
 * 
 *     # The two loops are independent, let's use
 *     for i in range(rows) :             # <<<<<<<<<<<<<<
 *         for j in range(cols) :
 ...
 */
  ...
  for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
    ...
    /* "MDAnalysis/lib/distances_parallel.pyx":144
 *     # The two loops are independent, let's use
 *     for i in range(rows) :
 *         for j in range(cols) :             # <<<<<<<<<<<<<<
 *             x = coordA[i,0] - coordB[j,0];
 ...
 */
      ...
      __pyx_t_4 = -1;
      if (__pyx_t_19 < 0) {
        __pyx_t_19 += __pyx_pybuffernd_coordA.diminfo[0].shape;
        if (unlikely(__pyx_t_19 < 0)) __pyx_t_4 = 0;
      } else if (unlikely(__pyx_t_19 >= __pyx_pybuffernd_coordA.diminfo[0].shape)) __pyx_t_4 = 0;
      if (__pyx_t_20 < 0) {
        __pyx_t_20 += __pyx_pybuffernd_coordA.diminfo[1].shape;
        if (unlikely(__pyx_t_20 < 0)) __pyx_t_4 = 1;
      } else if (unlikely(__pyx_t_20 >= __pyx_pybuffernd_coordA.diminfo[1].shape)) __pyx_t_4 = 1;
      if (unlikely(__pyx_t_4 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_4);
      ...
      __pyx_t_4 = -1;
      if (__pyx_t_21 < 0) {
        __pyx_t_21 += __pyx_pybuffernd_coordB.diminfo[0].shape;
        if (unlikely(__pyx_t_21 < 0)) __pyx_t_4 = 0;
      } else if (unlikely(__pyx_t_21 >= __pyx_pybuffernd_coordB.diminfo[0].shape)) __pyx_t_4 = 0;
      if (__pyx_t_22 < 0) {
        __pyx_t_22 += __pyx_pybuffernd_coordB.diminfo[1].shape;
        if (unlikely(__pyx_t_22 < 0)) __pyx_t_4 = 1;
      } else if (unlikely(__pyx_t_22 >= __pyx_pybuffernd_coordB.diminfo[1].shape)) __pyx_t_4 = 1;
      if (unlikely(__pyx_t_4 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_4);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 145; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
 ...
 */
      ...
      __pyx_t_4 = -1;
      if (__pyx_t_23 < 0) {
        __pyx_t_23 += __pyx_pybuffernd_coordA.diminfo[0].shape;
        if (unlikely(__pyx_t_23 < 0)) __pyx_t_4 = 0;
      } else if (unlikely(__pyx_t_23 >= __pyx_pybuffernd_coordA.diminfo[0].shape)) __pyx_t_4 = 0;
      if (__pyx_t_24 < 0) {
        __pyx_t_24 += __pyx_pybuffernd_coordA.diminfo[1].shape;
        if (unlikely(__pyx_t_24 < 0)) __pyx_t_4 = 1;
      } else if (unlikely(__pyx_t_24 >= __pyx_pybuffernd_coordA.diminfo[1].shape)) __pyx_t_4 = 1;
      if (unlikely(__pyx_t_4 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_4);
      ...
      __pyx_t_4 = -1;
      if (__pyx_t_25 < 0) {
        __pyx_t_25 += __pyx_pybuffernd_coordB.diminfo[0].shape;
        if (unlikely(__pyx_t_25 < 0)) __pyx_t_4 = 0;
      } else if (unlikely(__pyx_t_25 >= __pyx_pybuffernd_coordB.diminfo[0].shape)) __pyx_t_4 = 0;
      if (__pyx_t_26 < 0) {
        __pyx_t_26 += __pyx_pybuffernd_coordB.diminfo[1].shape;
        if (unlikely(__pyx_t_26 < 0)) __pyx_t_4 = 1;
      } else if (unlikely(__pyx_t_26 >= __pyx_pybuffernd_coordB.diminfo[1].shape)) __pyx_t_4 = 1;
      if (unlikely(__pyx_t_4 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_4);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 146; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
 ...
 */
      ...
      __pyx_t_4 = -1;
      if (__pyx_t_27 < 0) {
        __pyx_t_27 += __pyx_pybuffernd_coordA.diminfo[0].shape;
        if (unlikely(__pyx_t_27 < 0)) __pyx_t_4 = 0;
      } else if (unlikely(__pyx_t_27 >= __pyx_pybuffernd_coordA.diminfo[0].shape)) __pyx_t_4 = 0;
      if (__pyx_t_28 < 0) {
        __pyx_t_28 += __pyx_pybuffernd_coordA.diminfo[1].shape;
        if (unlikely(__pyx_t_28 < 0)) __pyx_t_4 = 1;
      } else if (unlikely(__pyx_t_28 >= __pyx_pybuffernd_coordA.diminfo[1].shape)) __pyx_t_4 = 1;
      if (unlikely(__pyx_t_4 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_4);
      ...
      __pyx_t_4 = -1;
      if (__pyx_t_29 < 0) {
        __pyx_t_29 += __pyx_pybuffernd_coordB.diminfo[0].shape;
        if (unlikely(__pyx_t_29 < 0)) __pyx_t_4 = 0;
      } else if (unlikely(__pyx_t_29 >= __pyx_pybuffernd_coordB.diminfo[0].shape)) __pyx_t_4 = 0;
      if (__pyx_t_30 < 0) {
        __pyx_t_30 += __pyx_pybuffernd_coordB.diminfo[1].shape;
        if (unlikely(__pyx_t_30 < 0)) __pyx_t_4 = 1;
      } else if (unlikely(__pyx_t_30 >= __pyx_pybuffernd_coordB.diminfo[1].shape)) __pyx_t_4 = 1;
      if (unlikely(__pyx_t_4 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_4);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 147; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
 ...
 */
        ...
        /* "MDAnalysis/lib/distances_parallel.pyx":152
 *             if has_box == 1:
 *                 x = x - box_x*round(x/box_x);
 *                 y = y - box_y*round(y/box_y);             # <<<<<<<<<<<<<<
 *                 z = z - box_z*round(z/box_z);
 ...
 */
        ...
        /* "MDAnalysis/lib/distances_parallel.pyx":153
 *                 x = x - box_x*round(x/box_x);
 *                 y = y - box_y*round(y/box_y);
 *                 z = z - box_z*round(z/box_z);             # <<<<<<<<<<<<<<
 *             dist = sqrt((x*x)+(y*y)+(z*z));
 ...
 */
      ...
      /* "MDAnalysis/lib/distances_parallel.pyx":154
 *                 y = y - box_y*round(y/box_y);
 *                 z = z - box_z*round(z/box_z);
 *             dist = sqrt((x*x)+(y*y)+(z*z));             # <<<<<<<<<<<<<<
 *             result[i,j] = dist;
 ...
 */
      ...
      /* "MDAnalysis/lib/distances_parallel.pyx":155
 *                 z = z - box_z*round(z/box_z);
 *             dist = sqrt((x*x)+(y*y)+(z*z));
 *             result[i,j] = dist;             # <<<<<<<<<<<<<<
 *     return result
 ...
 */
      ...
      } else if (unlikely(__pyx_t_31 >= __pyx_pybuffernd_result.diminfo[0].shape)) __pyx_t_4 = 0;
      if (__pyx_t_32 < 0) {
        __pyx_t_32 += __pyx_pybuffernd_result.diminfo[1].shape;
        if (unlikely(__pyx_t_32 < 0)) __pyx_t_4 = 1;
      } else if (unlikely(__pyx_t_32 >= __pyx_pybuffernd_result.diminfo[1].shape)) __pyx_t_4 = 1;
      if (unlikely(__pyx_t_4 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_4);
  ...
  /* "MDAnalysis/lib/distances_parallel.pyx":156
 *             dist = sqrt((x*x)+(y*y)+(z*z));
 *             result[i,j] = dist;
 *     return result             # <<<<<<<<<<<<<<
 * 
...
/* "MDAnalysis/lib/distances_parallel.pyx":163
 * 
...
static PyObject *__pyx_pw_3lib_8parallel_9distances_3distance_array(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("distance_array (wrapper)", 0);
  {
    ...
    /* "MDAnalysis/lib/distances_parallel.pyx":165
 * def distance_array(np.ndarray[DTYPE_t, ndim=2] coordA, \
 *                    np.ndarray[DTYPE_t, ndim=2] coordB, \
 *                    np.ndarray[DTYPE_t, ndim=1] box = None, \             # <<<<<<<<<<<<<<
 *                    np.ndarray[DTYPE_t, ndim=2] result = None):
 ...
 */
    ...
    /* "MDAnalysis/lib/distances_parallel.pyx":166
 *                    np.ndarray[DTYPE_t, ndim=2] coordB, \
 *                    np.ndarray[DTYPE_t, ndim=1] box = None, \
 *                    np.ndarray[DTYPE_t, ndim=2] result = None):             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "MDAnalysis/lib/distances_parallel.pyx":182
 *     cdef DTYPE_t box_x, box_y, box_z
 * 
 *     if box is not None:             # <<<<<<<<<<<<<<
 *         has_box = 1
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "MDAnalysis/lib/distances_parallel.pyx":183
 * 
 *     if box is not None:
 *         has_box = 1             # <<<<<<<<<<<<<<
 *         box_x = box[0]
 ...
 */
    ...
    /* "MDAnalysis/lib/distances_parallel.pyx":186
 *         box_x = box[0]
 *         box_y = box[1]
 *         box_z = box[2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "MDAnalysis/lib/distances_parallel.pyx":189
 * 
 *     # FIXME assume that coorA and coorB are of tha same length
 *     rows = coordA.shape[0];             # <<<<<<<<<<<<<<
 *     cols = coordB.shape[0];
 ...
 */
  ...
  /* "MDAnalysis/lib/distances_parallel.pyx":192
 *     cols = coordB.shape[0];
 * 
 *     if result is None:             # <<<<<<<<<<<<<<
 *         result = np.empty((rows, cols), dtype=DTYPE)
 ...
 */
    ...
    __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_empty); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 193; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_6 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_rows); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 193; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_8 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_cols); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 193; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_8);
    ...
    __Pyx_GOTREF(__pyx_t_9);
    __pyx_t_6 = __Pyx_GetModuleGlobalName(__pyx_n_s_DTYPE); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 193; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    if (PyDict_SetItem(__pyx_t_9, __pyx_n_s_dtype, __pyx_t_6) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 193; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_8, __pyx_t_9); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 193; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
 ...
 */
    ...
    if (unlikely(!Py_OptimizeFlag)) {
      if (unlikely(!(((__pyx_v_result->dimensions[0]) == __pyx_v_rows) != 0))) {
        __pyx_t_6 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_rows); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 195; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_6);
        __pyx_t_9 = __Pyx_PyInt_From_Py_intptr_t((__pyx_v_result->dimensions[0])); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 195; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_9);
        ...
        __pyx_t_6 = 0;
        __pyx_t_9 = 0;
        __pyx_t_9 = __Pyx_PyString_Format(__pyx_kp_s_Results_array_should_have_d_rows, __pyx_t_8); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 195; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_9);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
 ...
 */
    ...
    if (unlikely(!Py_OptimizeFlag)) {
      if (unlikely(!(((__pyx_v_result->dimensions[1]) == __pyx_v_cols) != 0))) {
        __pyx_t_9 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_cols); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 196; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_9);
        __pyx_t_8 = __Pyx_PyInt_From_Py_intptr_t((__pyx_v_result->dimensions[1])); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 196; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_8);
        ...
        __pyx_t_9 = 0;
        __pyx_t_8 = 0;
        __pyx_t_8 = __Pyx_PyString_Format(__pyx_kp_s_Results_array_should_have_d_colu, __pyx_t_6); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 196; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        PyErr_SetObject(PyExc_AssertionError, __pyx_t_8);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      ...
      /*try:*/ {
        {
            ...
            #endif
            #ifdef _OPENMP
            #pragma omp parallel  private(__pyx_t_22, __pyx_t_25, __pyx_t_15, __pyx_t_33, __pyx_t_26, __pyx_t_21, __pyx_t_28, __pyx_t_30, __pyx_t_18, __pyx_t_17, __pyx_t_20, __pyx_t_16, __pyx_t_1, __pyx_t_24, __pyx_t_32, __pyx_t_11, __pyx_t_31, __pyx_t_27, __pyx_t_23, __pyx_t_29, __pyx_t_19) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
            #endif /* _OPENMP */
            {
                #ifdef _OPENMP
                #ifdef WITH_THREAD
                ...
                /* "MDAnalysis/lib/distances_parallel.pyx":200
 *     with nogil, parallel():
 *         # The two loops are independent, let's use
 *         for i in prange(rows, schedule="dynamic", chunksize=50) :             # <<<<<<<<<<<<<<
 *             for j in range(cols) :
 ...
 */
                    ...
                    {
                        #ifdef _OPENMP
                        #pragma omp for lastprivate(__pyx_v_x) lastprivate(__pyx_v_y) lastprivate(__pyx_v_z) firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_j) lastprivate(__pyx_v_dist) schedule(dynamic, __pyx_t_11)
                        #endif /* _OPENMP */
                        for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_17; __pyx_t_16++){
                            if (__pyx_parallel_why < 2)
                            {
                                ...
                                /* "MDAnalysis/lib/distances_parallel.pyx":201
 *         # The two loops are independent, let's use
 *         for i in prange(rows, schedule="dynamic", chunksize=50) :
 *             for j in range(cols) :             # <<<<<<<<<<<<<<
 *                 x = coordA[i,0] - coordB[j,0];
 ...
 */
                                  ...
                                  __pyx_t_21 = 0;
                                  if (__pyx_t_20 < 0) __pyx_t_20 += __pyx_pybuffernd_coordA.diminfo[0].shape;
                                  if (__pyx_t_21 < 0) __pyx_t_21 += __pyx_pybuffernd_coordA.diminfo[1].shape;
 ...
 */
                                  ...
                                  __pyx_t_25 = 1;
                                  if (__pyx_t_24 < 0) __pyx_t_24 += __pyx_pybuffernd_coordA.diminfo[0].shape;
                                  if (__pyx_t_25 < 0) __pyx_t_25 += __pyx_pybuffernd_coordA.diminfo[1].shape;
 ...
 */
                                  ...
                                  __pyx_t_29 = 2;
                                  if (__pyx_t_28 < 0) __pyx_t_28 += __pyx_pybuffernd_coordA.diminfo[0].shape;
                                  if (__pyx_t_29 < 0) __pyx_t_29 += __pyx_pybuffernd_coordA.diminfo[1].shape;
 ...
 */
                                    ...
                                    /* "MDAnalysis/lib/distances_parallel.pyx":210
 *                     x = x - box_x*round(x/box_x);
 *                     y = y - box_y*round(y/box_y);
 *                     z = z - box_z*round(z/box_z);             # <<<<<<<<<<<<<<
 *                 # FIXME this might not be the optimal thing to do
 ...
 */
                                  ...
                                  /* "MDAnalysis/lib/distances_parallel.pyx":212
 *                     z = z - box_z*round(z/box_z);
 *                 # FIXME this might not be the optimal thing to do
 *                 dist = sqrt((x*x)+(y*y)+(z*z));             # <<<<<<<<<<<<<<
 *                 result[i,j] = dist;
 ...
 */
                                  ...
                                  /* "MDAnalysis/lib/distances_parallel.pyx":213
 *                 # FIXME this might not be the optimal thing to do
 *                 dist = sqrt((x*x)+(y*y)+(z*z));
 *                 result[i,j] = dist;             # <<<<<<<<<<<<<<
 *     return result
 ...
 */
  ...
  /* "MDAnalysis/lib/distances_parallel.pyx":214
 *                 dist = sqrt((x*x)+(y*y)+(z*z));
 *                 result[i,j] = dist;
 *     return result             # <<<<<<<<<<<<<<
 * 
...
#endif
{
  ...
  /* "MDAnalysis/lib/distances_parallel.pyx":85
 ...
 */
  ...
  /* "MDAnalysis/lib/distances_parallel.pyx":88
 * 
 * # Register a np.float64 as data type 'DTYPE_t'
 * DTYPE = np.float32             # <<<<<<<<<<<<<<
 * ctypedef np.float32_t DTYPE_t
