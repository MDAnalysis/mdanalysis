...
def minimize_periodic_vector(reference_point, center_position, box, backend="serial"):
    """Returns the periodic image of center_position which is closest to the reference_point
    Parameters
    ----------
    ...
    results : numpy.ndarray
        Coordinate of the periodic image of center_position which is closest to
        the reference_point
    """
    dx = reference_point - center_position
    ...
    if boxtype == 'ortho':
        _run("translate_periodic_ortho", args=(reference_point, center_position, result, box[:3]), backend=backend)
    else:
        _run("translate_periodic_triclinic", args=(reference_point, center_position, result, box), backend=backend)
