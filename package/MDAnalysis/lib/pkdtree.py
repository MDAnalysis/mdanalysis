...
class Periodic_cKDTree(object):
    ...
    def set_coords(self, coords, cutoff=None):
        ...
        if self.periodic:
            ...
            if cutoff is not None:
                raise RuntimeError('Donot provide cutoff distance for non PBC aware calculations')
            self.coords = coords
    ...
    def search(self, centers, radius):
        ...
        to enable distance evaluations from points in the tree and their images.
