...
try:
    import matplotlib, matplotlib.path, matplotlib.nxutils, matplotlib.pyplot
except ImportError:
    '2d streamplot module requires:matplotlib, matplotlib.path, matplotlib.nxutils, matplotlib.pyplot'

import MDAnalysis, multiprocessing, numpy, scipy
...
def split_grid(grid,num_cores):
    ...
    #print grid_vertex_cartesian_array
    #print grid_vertex_cartesian_array.shape 
    ...
    #print list_all_squares_in_grid
    ...
    #print list_square_vertex_arrays_per_core
...
def per_core_work(coordinate_file_path,trajectory_file_path,list_square_vertex_arrays_this_core,MDA_selection,start_frame,end_frame,reconstruction_index_list,maximum_delta_magnitude):
    ...
    #print 'reconstruction index list:', reconstruction_index_list
    #print list_square_vertex_arrays_this_core
    ...
    def produce_list_indices_point_in_polygon_this_frame(vertex_coord_list):
        ...
        for square_vertices in vertex_coord_list:
            ...
            #if index_list_in_polygon[0].size < 1: print 'null index list'
    ...
    def produce_list_centroids_this_frame(list_indices_in_polygon):
        ...
        for indices in list_indices_in_polygon:
            if not indices[0].size > 0: #if there are no particles of interest in this particular square
                ...
                #print 'current_coordinate_array_in_square:',current_coordinate_array_in_square
    ...
    #I'm going to take the list of square vertices given to this core and convert it to a list of square centroids to simplify downstream sorting and reconstruction of the overall data matrix in the parent
    #list_square_centroids = [numpy.average(array,axis=0).tolist() for array in list_square_vertex_arrays_this_core]
    #instead of providing a list of square centroids to the parent, what I really want is the actual assignment position within the appropriately-shaped numpy array

    return zip(reconstruction_index_list,xy_deltas_to_write.tolist())

def main(coordinate_file_path,trajectory_file_path,grid_spacing,MDA_selection,start_frame,end_frame,xmin,xmax,ymin,ymax,maximum_delta_magnitude,num_cores='maximum'):
