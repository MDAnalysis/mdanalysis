...
class H5MDReader(base.ReaderBase):
    ...
    def Writer(self, filename, **kwargs):
        """Returns a H5MDWriter for `filename` with the same parameters as this H5MD.
        ...
        ----------
        filename : str
            filename of the output H5MD trajectory
        ...
        #n_frames = kwargs.pop('n_frames', self.n_frames)

        return H5MDWriter(filename, n_atoms, n_frames, **kwargs)
