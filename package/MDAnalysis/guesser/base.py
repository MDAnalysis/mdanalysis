class GuesserBase:
    ...
    def is_guessed(self, to_guess):
        ...
        for a in to_guess:
            if a.lower() not in self._guess:
                raise ValueError ('{0} guesser can not guess the {1} atrribute '.format(self.context, a))
        return True
    ...
    def setAtoms(self, atoms):
        """get the AtomGroup of the universe to use its attributes inside the guessing methods
