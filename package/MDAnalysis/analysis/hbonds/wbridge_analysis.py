...
This module is moved to :class:`MDAnalysis.analysis.hydrogenbonds.WaterBridgeAnalysis`."""

from MDAnalysis.analysis.hydrogenbonds.WaterBridgeAnalysis import WaterBridgeAnalysis
