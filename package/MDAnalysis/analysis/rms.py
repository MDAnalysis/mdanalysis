...
def rmsd(a,b, weights=None):
    """Returns RMSD between two coordinate sets *a* and *b*. An implicit
    optimal superposition is performed, which minimizes the RMSD between
    *a* and *b*.
    ...
    *a* and *b* are arrays of the coordinates of N atoms of shape N*3
    ...
    Both *a* and *b* must be centered before performing the RMSD
    calculation.
