...
__all__ = [
    ...
    "PRMErr1",
    "PRMErr2",
    "PRMErr3",  # Amber TOP files to check raised errors
...
WIN_PDB_multiframe = resource_filename(
    __name__, "data/windows/WIN_nmr_neopetrosiamide.pdb"
)
WIN_DLP_HISTORY = resource_filename(__name__, "data/windows/WIN_HISTORY")
WIN_TRJ = resource_filename(__name__, "data/windows/WIN_ache.mdcrd")
WIN_ARC = resource_filename(__name__, "data/windows/WIN_test.arc")
WIN_LAMMPSDUMP = resource_filename(__name__, "data/windows/WIN_wat.lammpstrj")

legacy_DCD_NAMD_coords = resource_filename(__name__, "data/legacy_DCD_NAMD_coords.npy")
legacy_DCD_ADK_coords = resource_filename(__name__, "data/legacy_DCD_adk_coords.npy")
legacy_DCD_c36_coords = resource_filename(__name__, "data/legacy_DCD_c36_coords.npy")
...
COORDINATES_GRO_INCOMPLETE_VELOCITY = resource_filename(
    __name__, "data/coordinates/test_incomplete_vel.gro"
)
...
COORDINATES_XYZ_BZ2 = resource_filename(__name__, "data/coordinates/test.xyz.bz2")
...
PDB_sameresid_diffresname = resource_filename(
    __name__, "data/sameresid_diffresname.pdb"
)
...
GRO_sameresid_diffresname = resource_filename(
    __name__, "data/sameresid_diffresname.gro"
)
...
TPR2019B3_bonded = resource_filename(
    __name__, "data/tprs/all_bonded/dummy_2019-beta3.tpr"
)
TPR2020B2_bonded = resource_filename(
    __name__, "data/tprs/all_bonded/dummy_2020-beta2.tpr"
)
TPR2020_bonded = resource_filename(__name__, "data/tprs/all_bonded/dummy_2020.tpr")
TPR2020_double_bonded = resource_filename(
    __name__, "data/tprs/all_bonded/dummy_2020_double.tpr"
)
# all interactions
TPR_EXTRA_2020 = resource_filename(
    __name__, "data/tprs/virtual_sites/extra-interactions-2020.tpr"
)
TPR_EXTRA_2018 = resource_filename(
    __name__, "data/tprs/virtual_sites/extra-interactions-2018.tpr"
)
TPR_EXTRA_2016 = resource_filename(
    __name__, "data/tprs/virtual_sites/extra-interactions-2016.3.tpr"
)
TPR_EXTRA_407 = resource_filename(
    __name__, "data/tprs/virtual_sites/extra-interactions-4.0.7.tpr"
)
...
HELANAL_BENDING_MATRIX = resource_filename(
    __name__, "data/helanal_bending_matrix_AdK_DIMS_H8.dat"
)
HELANAL_BENDING_MATRIX_SUBSET = resource_filename(
    __name__, "data/helanal_bending_matrix_AdK_DIMS_H8_frames10to79.dat"
)
...
mol2_comments_header = resource_filename(
    __name__, "data/mol2/Molecule_comments_header.mol2"
)
...
contacts_villin_folded = resource_filename(
    __name__, "data/contacts/villin_folded.gro.bz2"
)
contacts_villin_unfolded = resource_filename(
    __name__, "data/contacts/villin_unfolded.gro.bz2"
)
...
two_water_gro_multiframe = resource_filename(
    __name__, "data/two_water_gro_multiframe.gro"
)
