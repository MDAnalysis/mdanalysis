...
class TestAverageStructure(object):
    ...
    def test_average_structure_mass_weighted(self, universe, reference): # FIXME: fails with `localdask` if I provide scheduler
    ...
    def test_average_structure_select(self, universe, reference): # FIXME: fails with `localdask` if I provide scheduler
    ...
    def test_average_structure_no_ref(self, universe): # FIXME: fails with `localdask` if I provide scheduler
    ...
    def test_average_structure_ref_frame(self, universe): # FIXME: fails with `localdask` if I provide scheduler
        ref_frame = 3
    ...
    def test_average_structure_in_memory(self, universe): # FIXME: fails with `localdask` if I provide scheduler
