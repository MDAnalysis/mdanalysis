...
MDAnalysis_ is a Python library for the analysis of molecular dynamics (MD) simulations and other computer simulations of many-body systems at the molecular scale. It supports workflows ranging from studying drug–protein interactions to exploring novel materials. The library is widely used in the scientific community and is developed by scientists for scientists. 
