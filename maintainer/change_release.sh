...
git grep -E -l 'RELEASE.*[0-9]+\.[0-9]+\.[0-9]+(\.[0-9]+)?(-devel|-dev)?' $FILES  \
   | xargs -I FILE $SED '/RELEASE/s/[0-9]+\.[0-9]+\.[0-9]+(\.[0-9]+)?(-devel|-dev)?/'${RELEASE}'/' -i.bak FILE
git grep -E -l '__version__ =.*[0-9]+\.[0-9]+\.[0-9]+(\.[0-9]+)?(-devel|-dev)?'  $FILES \
   | xargs -I FILE $SED '/__version__/s/[0-9]+\.[0-9]+\.[0-9]+(\.[0-9]+)?(-devel|-dev)?/'${RELEASE}'/' -i.bak FILE
git status
